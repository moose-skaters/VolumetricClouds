...
#define UBPA_TRANSFER_FOG(v2f, vertex) v2f##._fogCoord = GetExponentialHeightFog(TransformObjectToWorld(vertex) - _WorldSpaceCameraPos)

#define UBPA_APPLY_FOG(v2f, pixelColor) pixelColor = float4(pixelColor.rgb * v2f._fogCoord.a + v2f._fogCoord.rgb, pixelColor.a)
...
float4 GetExponentialHeightFog(float3 WorldPositionRelativeToCamera) // camera to vertex
{
